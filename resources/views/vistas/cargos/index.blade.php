...
@section('content')
    ...
    <div class="pb-1 pt-2 d-flex flex-wrap gap-2">
        ...
        <a href="{{ route('cargos.vacearRegistro') }}" onclick="return confimar_eliminar()"
                ...
                <div class="modal-body">
                    <form action="{{ route('cargos.store') }}" method="POST">
                        ...
                        <div class="fl-flex-label mb-4 px-2 col-12">
                            <input required type="text" placeholder="Nombres del cargo" class="input input__text"
                        ...
                        <tr>
                            ...
                            <td>
                                <a style="top: 0" href="" data-toggle="modal"
                                    data-target="#modificar{{ $item->id_cargo }}" class="btn btn-sm btn-warning m-1"><i
                                        class="fas fa-edit"></i></a>

                                <form action="{{ route('cargos.destroy', $item->id_cargo) }}" method="POST"
                                    class="d-inline formulario-eliminar">
                                    @csrf
                                    @method('delete')
                                </form>
                                <a href="#" class="btn btn-sm btn-danger eliminar" data-id="{{ $item->id_cargo }}">
                            ...
                            <div class="modal fade" id="modificar{{ $item->id_cargo }}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('cargos.update', $item->id_cargo) }}"
                                                method="POST">
                                                @csrf
                                                @method('put')
                                                <div hidden class="fl-flex-label mb-4 px-2 col-12">
                                                    <input type="text" placeholder="ID" class="input input__text"
                                                        name="txtid" value="{{ $item->id_cargo }}">
                                                </div>
