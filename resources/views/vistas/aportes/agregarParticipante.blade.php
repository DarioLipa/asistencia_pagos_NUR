...
@section('content')
    ...
    <h4 class="text-center text-secondary">AGREGA APORTANTES</h4>
            ...
            @foreach ($aporte as $itemAporte)
                <div class="text-right p-2">
                    <button type="button" id="btnGuardarSalir" class="btn btn-success"><i class="fas fa-save"></i>
                        Agregar</button>
                    <a href="{{ route('aportes.eliminarParticipante', $itemAporte->id_aporte) }}"
                ...
                <div class="alert alert-success font-weight-bold p-2">{{ $itemAporte->titulo }}
                </div>
            @endforeach
